...
<body>
    ...
    <div class="list">
        ...
        <table>
            ...
            <?php
<<<<<<< HEAD:developpement/src/app/Views/liste_visite.php
            $i=0;
...
>>>>>>> a4d53debce355c98e228ebf5a81710f3af67eb27:developpement/src/app/Views/listeVisiteView.php
            ?>
        </table>
    </div>
    <div class="popup-back" popup_id="p_form_visite">
        <form action="<?=base_url();?>/visite/ajouter" method="POST" class="popup-form">
            <div class="relative">
                <button type="button"><img src="assets/image/button/fermer-la-croix.png" alt="fermer"
                        class="close-popup absolute right-0 top-0 w-4 h-4" popup_to_close="p_form_visite"></button>
            </div>
...
=======
                <textarea name="" id="" cols="20" rows="5"
                    class="shadow appearance-none border rounded w-full py-2 px-3 focus:ring-1 focus:ring-blue-300 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"></textarea>
>>>>>>> a4d53debce355c98e228ebf5a81710f3af67eb27:developpement/src/app/Views/listeVisiteView.php
            </div>
