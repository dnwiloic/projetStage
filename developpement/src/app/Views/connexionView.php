    ...
    <div class="flex flex-col justify-center items-center w-screen basis-full min-h-screen">
        <form action="<?=base_url();?>/connexion/connexion" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="login" name="login" type="text" placeholder="Username">
            </div>
            <div class="mb-6">
